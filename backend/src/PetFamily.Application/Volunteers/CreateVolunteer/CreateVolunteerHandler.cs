    ...
    public class CreateVolunteerHandler
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var fullNameResult = FullName.Create(request.FullName.LastName,
                request.FullName.FirstName, request.FullName.Patronymic);
            ...
            var volunteerResul = Volunteer.Create(volunteerId, fullNameResult.Value,
                request.Email, request.Description, request.YearsOfExperience,
                request.PhoneNumber, socialNetworksList, requisitesList);
