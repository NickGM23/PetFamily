            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.TypeAccounts.VolunteerAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_volunteer_accounts_asp_net_users_user_id");
                    ...
                    b.OwnsOne("PetFamily.SharedKernel.ValueObjects.RequisiteList", "Requisites", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_volunteer_accounts_volunteer_accounts_id");
                        });
